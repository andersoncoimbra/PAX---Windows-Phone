...
namespace PAX___Windows_Phone.Common
{
    /// <summary>
    /// NavigationHelper ajuda na navegação entre páginas.  Fornece comandos usados para 
    /// voltar e avançar, e registra-se para atalhos padrão de mouse e teclado
    /// atalhos usado para voltar e avançar no Windows e o botão Voltar de hardware no
    /// Windows Phone. Além disso, integra o SuspensionManger para lidar com a vida útil do gerenciamento de processo
    /// e gerenciamento de estado ao navegar entre páginas.
    /// </summary>
    ///<exemplo>
    /// Para usar o NavigationHelper, siga estas duas etapas ou
    /// comece com uma Página Básica ou qualquer outro modelo de Página diferente de Página em Branco.
    /// 
    /// 1) Crie uma instância do NavigationHelper em algum lugar, como no 
    ///     construtor da página, e registre um callback para os eventos LoadState e 
    ///     SaveState.
    ///<código>
    ///     public MyPage()
    ///     {
    ...
    public class NavigationHelper : DependencyObject
    {
        ...
        public NavigationHelper(Page page)
        {
            ...
            //1) Mapeie o estado de exibição do aplicativo para o estado visual da página
        ...
        /// como a Ação Execute e <see cref="CanGoBack"/> para CanExecute.
        /// </summary>
        ...
        /// como a Ação Execute e <see cref="CanGoForward"/> para CanExecute.
        /// </summary>
        ...
        /// </summary>
        /// <param name="e">Dados de evento que descrevem como essa página foi atingida. A propriedade
        /// Parameter fornece o grupo a ser exibido.</param>
