...
{
    /// <summary>
    /// Um comando cujo único propósito é dedicar sua funcionalidade 
    ...
    public class RelayCommand : ICommand
    {
        ...
        /// </param>
        /// <returns>true se esse comando puder ser executado; caso contrário, false.</returns>
        ...
        /// <summary>
        /// Executa o <see cref="RelayCommand"/> no atual destino do comando atual.
        /// </summary>
        /// <param name="parameter">
        /// Dados usados pelo comando. Se o comando não exigir que os dados sejam passados, esse objeto pode ser configurado como nulo.
        /// </param>
        ...
        /// <summary>
        /// Método usado para lançar o evento <see cref="CanExecuteChanged"/>
        /// para indicar que o valor de retorno do método <see cref="CanExecute"/>
        /// mudou.
        /// </summary>
