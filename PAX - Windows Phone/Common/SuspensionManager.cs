...
namespace PAX___Windows_Phone.Common
{
    ...
    /// condições e deverá ser usado somente para armazenar informações que seriam convenientes para
    /// serem transportadas entre sessões, mas devem ser descartadas quando um aplicativo falhar ou for
    /// atualizado.
    /// </summary>
    internal sealed class SuspensionManager
    {
        ...
        /// <see cref="RestoreAsync"/>, de modo que os valores possam ser serializáveis por
        /// <see cref="DataContractSerializer"/> e serem compactados o máximo possível.  Cadeias de caracteres
        ...
        /// quando ao ler e escrever estado da sessão.  Inicialmente vazia, tipos adicionais podem ser
        ...
        ///imediatamente após a criação se eles forem participar do gerenciamento de estado da sessão.
        /// Se o estado tiver sido restaurado quando for feito o registro para a chave especificada,
        ///o histórico da navegação será restaurado imediatamente.  Invocações subsequentes de
        /// <see cref="RestoreAsync"/> também irão restaurar o histórico de navegação.
        /// </summary>
